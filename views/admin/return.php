...
<head>
    ...
    <title>Manage Returns | FMWare</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Manage Returns | FMWare">
...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    ...
    <script src="/asset/js/admin/return.js"></script> <!--end::Script-->
</body><!--end::Body-->
