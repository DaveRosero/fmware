<?php
  ...
  require_once 'model/admin/attributesClass.php';
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] == 'new_attr') {
        $attr->newAttribute();
    }
    if ($_POST['action'] == 'new_variant') {
        $attr->newVariant();
    }
  }
?>
...
<head>
    ...
    <title>Manage Attributes | FMWare</title>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <!-- Content Start -->
        <?php include 'views/admin/content/attributes-content.php'; ?>
      <!-- Content End -->  
