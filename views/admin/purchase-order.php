...
<head>
    ...
    <title>Purchase Orders | FMWare</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Purchase Orders | FMWare">
...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper">
        ...
        <?php require_once 'views/admin/content/purchase-order-content.php'; ?>
        <?php require_once 'views/admin/modals/purchase-order-modal.php'; ?>
    ...
    <script src="/asset/js/admin/purchase-order.js"></script> <!--end::Script-->
</body><!--end::Body-->
