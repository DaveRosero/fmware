...
<head>
    ...
    <title>Manage Categories | FMWare</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Manage Categories | FMWare">
...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper">
        ...
        <?php require_once 'views/admin/content/category-content.php'; ?>
        <?php require_once 'views/admin/modals/category-modal.php'; ?>
    ...
    <script src="/asset/js/admin/category.js"></script> <!--end::Script-->
</body><!--end::Body-->
