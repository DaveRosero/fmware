...
<head>
    ...
    <title>Manage Orders | FMWare</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Manage Orders | FMWare">
...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    ...
    <script src="/asset/js/admin/order.js"></script> <!--end::Script-->
</body><!--end::Body-->
