...
<head>
    ...
    <title>Create Reports | FMWare</title><!--begin::Primary Meta Tags-->
...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper">
        ...
        <?php require_once 'views/admin/content/create-reports-content.php'; ?>
    ...
    <script src="/asset/js/admin/create-report.js"></script><!--end::Script-->
</body><!--end::Body-->
