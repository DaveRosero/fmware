...
<head>
    ...
    <title>Receive Purchase Order | FMWare</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Receive Purchase Order | FMWare">
...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper">
        ...
        <?php require_once 'views/admin/content/receive-po-content.php'; ?>
    ...
    <script src="/asset/js/admin/receive-po.js"></script> <!--end::Script-->
</body><!--end::Body-->
