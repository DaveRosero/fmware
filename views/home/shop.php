        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#" data-bs-toggle="collapse" data-bs-target="#paintCollapse" aria-expanded="false" aria-controls="paintCollapse">
                            Paint
                            <i class="fa fa-fw fa-chevron-circle-down mt-1"></i>
                        </a>
                        <div id="paintCollapse" class="accordion-collapse collapse show" aria-labelledby="paintHeading" data-bs-parent="#paintAccordion">
                            <ul class="list-unstyled pl-3">
                                <li><a class="text-decoration-none" href="#">Boysen</a></li>
                                <li><a class="text-decoration-none" href="#">Davies</a></li>
                                <li><a class="text-decoration-none" href="#">Titan</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                    ...
                    <div class="col-md-6 pb-4">
                        <div class="d-flex">
                            <select class="form-control">
                                ...
                                <option>Stock: Lowest to Highest</option>
                                <option>Stock: Highest to Lowest</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="#" class="h3 text-decoration-none fw-bold">Sample Product</a>
                                    <p class="mb-0">$250.00</p>
                                    <p class="mb-0"> In-stock: 20</p>
                                </div>
                                <div class="text-end">
